 ...
 <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="rank-orders">
                                    ...
                                    <span class="orders"><?= $model['qty'] ?> <?= Yii::t('app','Orders') ?></span>
                                </div>
                                ...
                                <div class="right-block">
                                    <h5 class="product-name"><a href="/detail/<?= $model['id'] ?>-<?= \Yii::$app->func->makeAlias($model['name']); ?>"> <?= Yii::$app->func->limitStr($model['name'], 60) ?></a></h5>
