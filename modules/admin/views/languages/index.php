...
?>
<div class="page-content sub-page-content languages-index">
     ...
     <?=  yii\base\View::render('../elements/breadcrumbs',['breadcrumbs'=>$this->params['breadcrumbs']]); ?>    
        ...
        $gridColumns = [
            ...
            [
                        'attribute' => 'flag',
                        'format'    => 'html',
                        'value'     => function($data) { return $data->Iconflag; },
            ...
            [
                        'attribute' => 'is_active',
                        'format'    => 'raw',
                        'value'     => function($data) { return $data->statusLanguageAjax; },
...
<script>
    function ajaxUpdateStatus( id ){
        $.get('<?= Yii::$app->params['url_admin'] ?>/languages/ajaxupdate?id='+id, function(html) {
